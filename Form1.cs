...
namespace lab04
{
    public partial class Form1 : Form
    {
        ...
        Viewport background = new Viewport();
        ...
        private void openGLControl_Resized(object sender, EventArgs e)
        {
            ...
            gl.LookAt(c._eyeX, c._eyeY, c._eyeZ, c._lookX, c._lookY, c._lookZ, 0, 1, 0);
        ...
        private void openGLControl_OpenGLDraw(object sender, RenderEventArgs args)
        {
            ...
            background.Draw(openGLControl, 50);
            ...
            lbCamPosX.Text = Math.Round(c._eyeX, 3).ToString();
            lbCamPosY.Text = Math.Round(c._eyeY, 3).ToString();
            lbCamPosZ.Text = Math.Round(c._eyeZ, 3).ToString();
        }
        ...
        //Nhận các phím Z, X, Left, Right, Up, Down thao tác với cera
        ...
        private void lboxObjectsList_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (existObject == false && index != -1)
            {
                ...
                // Bật textbox scale của đối tượng được chọn
                tbScaleX.Enabled = true;
                tbScaleY.Enabled = true;
                tbScaleZ.Enabled = true;

                // Bật textbox position của đối tượng được chọn
                tbPosX.Enabled = true;
                tbPosY.Enabled = true;
                tbPosZ.Enabled = true;

                // Bật textbox rotate của đối tượng được chọn
                tbRotX.Enabled = true;
                tbRotY.Enabled = true;
                tbRotZ.Enabled = true;
            ...
            if (prev_index != index && index >= 0)
            {
                ...
                if (prev_index != -1)
                    ...
                    Draw.listObject[prev_index]._Solid = false;
                // Rồi đổi đường viền đối tượng mới được chọn sang màu c đậm
